...
# # 1. Tentukan BASE_DIR dan PATH file model (WAJIB DI ATAS, SEBELUM DIGUNAKAN)
...
#         steps_final_text = " ".join(steps_list).strip()
#         steps_final_text = re.sub(r';+', '', steps_final_text).strip(" ;")

#         if not steps_final_text:
#             steps_final_text = "Potong bahan sesuai selera, tumis atau rebus hingga matang."
#         else:
#             steps_final_text = steps_final_text[0].upper() + steps_final_text[1:]
